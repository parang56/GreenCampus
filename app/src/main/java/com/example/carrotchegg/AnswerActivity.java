...
public class AnswerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = FirebaseFirestore.getInstance()
                .collection("userData").document(uid).collection("answer")
        ...
        adapter = new FirestoreRecyclerAdapter<UserData, AnswerHolder>(options) {

            @Override
            public void onBindViewHolder(AnswerHolder holder, int position, UserData model) {
                holder.bind(model, AnswerActivity.this);
            }

            @Override
            public AnswerHolder onCreateViewHolder(ViewGroup group, int i) {
