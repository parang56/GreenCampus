...
public class QuestionHolder extends RecyclerView.ViewHolder {
    ...
    void bind(@NonNull UserData question, Context applicationContext) {


        db.collection("subjects").document(question.getSubject())
                .collection("post").document(Long.toString(question.getPost()))
        ...
        postLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //클릭 시 해당 게시글로 이동
                questionParcelableData data = new questionParcelableData(question.getSubject(), (int) question.getPost());
